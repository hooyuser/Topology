...
\begin{proof}
	...
	\begin{align*}
		...
		p&\longmapsto (p,1)
	\end{align*}
	We only need to show this proposition for $Y=I$ and $f=i_0$, $g=i_1$. To see this, we assume $h$ is a homotopy between $f$ and $g$. Then we have
	\begin{equation*}
		\begin{tikzcd}		
		...
		\end{tikzcd}			
	\end{equation*}
	$f=h\circ i_0$ and $g=h\circ i_1$. Since $h$ is a homotopy, we have $h\circ i_0=h\circ i_1$. 
\end{proof}
