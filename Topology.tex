...
\begin{definition}{Haar Measure}{}
	...
	A \textbf{Haar measure} on a locally compact group $G$ is a left-invariant regular Borel measure on $G$ that is finite on compact sets and nonzero on open sets.
\end{definition}
