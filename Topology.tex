...
\begin{definition}{First-Countable Space}{}
	A \textbf{first-countable} space is a topological space such that for any point $x$ in the space, there exists a countable neighborhood base at $x$.
\end{definition}
...
\begin{proposition}{}{}
	If $f: X \rightarrow Y$ is a proper continuous map and $Y$ is a compactly generated Hausdorff space (this includes Hausdorff spaces that are either first-countable or locally compact), then $f$ is closed.
\end{proposition}
...
\begin{proposition}{Equivalent Definitions of Hausdorff Space}{}
	...
	\end{enumerate}
\end{proposition}
A countable sequence of points converges to a point if for every neighborhood of that point, there is a positive integer such that all points in the sequence after that integer are in the neighborhood.
\begin{proposition}{Properties of Hausdorff Space}{properties_of_hausdorff_space}
	...
	\begin{enumerate}[(i)]
		...
		\item Suppose $x\in X$ and $A$ is a compact subset of $X$ such that $x\notin A$. Then there exist neighborhoods $U$ of $x$ and $V$ of $A$ such that $U\cap V=\varnothing$.
	\end{enumerate}
\end{proposition}
\begin{prf}
	\begin{enumerate}[(i)]
...
\begin{definition}{Proper Topological Group Action}{}
	...
	is a \hyperlink{th:proper_map}{proper map}.
\end{definition}
...
\end{corollary}
\begin{prf}
	Since \hyperlink{th:equivalent_definition_of_local_homeomorphism}{local homeomorphisms are open maps}, the result follows from \Cref{th:covering_map_is_local_homeomorphism}.
