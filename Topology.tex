...
\pf{ 
	$p_*: \pi_1(E, e) \to \pi_1(X, x)$ as a map between sets is the restriction of the bijiection $p_*:\mathrm{St}(e)\to\mathrm{St}(p(e))$ to $\pi_1(E, e)$. Therefore it is injective, which implies $p_*$ is a monomorphism between groups.
}
...
\dfn{Monodromy Functor $\mathrm{Fib}$}{
	Monodromy functor $\mathrm{Fib}$ is defined as follows
	\begin{equation*}
		\begin{tikzcd}[ampersand replacement=\&]
...
\thm{Fundamental Theorem of Covering Spaces}{
