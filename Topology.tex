...
Orientable surface of genus $g$ is a surface that has $g$ holes. It is denoted by $S_g$. For $g\ge 1$, $S_g$ can be described by a $4g$-gon with some edges identified as follows
\begin{center}
	\begin{tikzpicture}
		\def\n{16} % Number of sides
