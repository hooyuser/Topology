...
\begin{prf}
	...
	Conversely, if $f(X)$ is closed in $Y$, then for any closed set $A\subseteq X$. Since $f:X\to f(X)$ is a homeomorphism, $f(A)$ is closed in $f(X)$. According to \Cref{th:closed_subset_of_closed_subspace_is_closed}, $f(A)$ is closed in $Y$. Hence $f$ is a closed map.
\end{prf}
