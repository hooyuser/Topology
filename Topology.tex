...
\prop{Continuous Map onto Image}{
...
\prop{Subspace of Subspace is Subspace}{
...
\prop{Sufficient Condition for Compactness}{
	...
	\begin{enumerate}[(i)]
		...
		\item In a metrizable space, a subset is compact if and only if it is sequentially compact.
		\item A finite set endowed with any topology is compact.
	\end{enumerate}
}

\dfn{Compact Continuous Mapping}{
...
\dfn{Irreducible Topological Space}{
...
\prop{Properties of Irreducible Topological Space}{
...
\chapter{Continuous Group Action}
...
\dfn{Group Action on Topological Space}{
...
\dfn{Continuous Topological Group Action on Topological Space}{
...
\dfn{Even Action}{
Let $G$ be a group acting continuously on a topological space $E$. The action of $E$ is \textbf{even} if each point $y \in Y$ has some neighborhood $U$ such that $gU\cap U=\varnothing$ for all $g\in G-\{1_G\}$. In other words, $U \cap gU \neq \varnothing$ implies $g=1_G$.
}
...
\prop[uniqueness_of_liftings]{Uniqueness of Liftings}{
...
\lemm[lemma_monodromy_action_same_image]{}{
...
\prop{Stabilizer of Monodromy Action}{
