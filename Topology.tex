...
\begin{prf}
	...
	\pi(\pi^{-1}(U))=U.
	\]
	According to \Cref{th:openness_of_product_map}, since each $\pi_i$ is a surjective open map, $\pi$ is an open map. Therefore, $U$ is open in $\prod_{i \in I} Y_i$.
...
\begin{prf}
	...
	\begin{align*}
		...
		h         & \longmapsto ghg^{-1}
	\end{align*}
	is continous. According to \Cref{th:continuous_map_equivalent_definition}, 
	\[
