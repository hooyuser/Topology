...
\begin{definition}{Normal Space}{}
	A topological space $X$ is a \textbf{normal space} space if, given any disjoint closed sets $E$ and $F$ in $X$, there are neighbourhoods $U$ of $E$ and $V$ of $F$ such that $U\cap V=\varnothing$.
\end{definition}
...
\end{definition}
\begin{proposition}{}{}
	Let $G\acts E$. If $p: E\to G\backslash E$ is a covering, it is a $G$-principal covering. So \Cref{th:relation_between_even_action_and_covering} can be restated as $G \acts E$ is an even action if and only if $p: E\to G\backslash E$ is a $G$-principal covering and $G \acts E$ is free.
\end{proposition}
\begin{proof}
